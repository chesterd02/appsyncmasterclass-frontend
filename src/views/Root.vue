<template>
  <div class="flex w-full h-screen" v-escape="esc">
      <!-- left side -->
      <div class="flex w-1/2 h-ful bg-blue">
        <div class="flex items-center justify-center w-full h-full">
            <div class="flex flex-col">
                <div class="flex items-center">
                    <i class="fas fa-user text-white text-2xl mr-5"></i>
                    <p class="text-white font-bold text-xl">Create your free Bitszer accout.</p>
                </div>
                <div class="flex items-cente mt-10">
                    <i class="fas fa-user-friends text-white text-2xl mr-4"></i>
                    <p class="text-white font-bold text-xl">See what your friends are selling</p>
                </div>
                <div class="flex items-center mt-10">
                    <i class="fas fa-play text-white text-2xl mr-4"></i>
                    <p class="text-white font-bold text-xl">Join the revolution</p>
                </div>
            </div>
        </div>     
      </div>
    ...
    <div class="flex w-1/2 h-full">
      <div class="flex flex-col w-1/2 font-bold">
        <i class="fab fa-hive text-blue text-4xl mb-5"></i>
        <p class="text-3xl mb-12">See what's selling right now</p>
        <p>Join Bitszer today.</p>
        ...
        <div class="modal-main bg-white w-11/12 mx-auto rounded-lg z-50 overflow-y-auto max-h-full">
            <div v-if="showModal === 'step1'">
                <div class="pl-1 pr-4 py-1 h-12">
                    <button @click="setSignupStep('step2')" class="rounded-full bg-blue font-bold text-white mt-2 p-1 pl-3 pr-3 realative right-0 float-right hover:bg-darkblue" :class="`${!name || !email || !birthdate ? 'opacity-50 cursor-not-allowed':''}`">Next</button>
                    <i class="flex justify-center fab fa-bitcoin text-blue text-2xl mt-2 mb-8"></i>
                </div>
                <div class="pt-5 px-8">
